...
where emp_id=10
				...
				---Sub Query--- (You need to write subqueries if your data is in multiple  table)
...
select e.emp_id, emp_name, g.emp_gender,emp_department,c.emp_city into joins_table
from emp_data e
INNER JOIN gender g
